...
const addactivity = async (req, res) => {
    try {
        ...
        io.to(userId.toString()).emit('updateActivityOrder',updateuser.activity_order);
...
const updateActivityOrder = async (userId, newOrder) => {
    try {
        ...
        const userwithactivities = await users.findById(userId).populate('activity_order');
...
module.exports={register,registeruser,login,loginuser,dashboard,activity,addactivity,updateActivityOrder,updateactivity,deleteactivity,oldactivity}
